...
async function cargarDatosPedido(id) {
    ...
    await configurarDataTableProductos(detalleProd);
    await configurarDataTableInsumos(insumosEnriquecidos);
...
async function procesarProducto(insumosProducto) {
