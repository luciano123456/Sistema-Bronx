...
namespace SistemaBronx.Application.Controllers
{
    ...
    public class StockTiposMovimientosController : Controller
    {
        private readonly IStockTiposMovimientoService _Tiposervice;

        public StockTiposMovimientosController(IStockTiposMovimientoService Tiposervice)
        {
        ...
        {
            var Tipo = new StockTiposMovimiento
            {
                Id = model.Id,
                Nombre = model.Nombre,
            };
